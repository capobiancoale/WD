...
CREATE TABLE payment (
  ...
  payment_method VARCHAR(80)   NOT NULL
    CHECK (payment_method IN ('visa','mastercard','gift_card','maestro','paypal','bank_transfer','cash')),
